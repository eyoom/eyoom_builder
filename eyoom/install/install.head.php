...
$eyoom_basic2_file = G5_DATA_PATH.'/eyoom.basic2.config.php';
$eyoom_pc_basic2_file = G5_DATA_PATH.'/eyoom.pc_basic2.config.php';
...
$eyoom_basic2 = '../..'.$eyoom_basic2_file;
$eyoom_pc_basic2 = '../..'.$eyoom_pc_basic2_file;
